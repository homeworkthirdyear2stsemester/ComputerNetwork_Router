...
public class NILayer implements BaseLayer {
	...
	private static void getAdapterListInstance() { // Mac 주소를 가져와 준다. -> GUI 에서 호출
	...
	public void setUpperLayer(BaseLayer pUpperLayer) {
		if (pUpperLayer == null)
			return;
		this.p_aUpperLayer.add(nUpperLayerCount++, pUpperLayer);//layer 추가
		// nUpperLayerCount++;
	}
